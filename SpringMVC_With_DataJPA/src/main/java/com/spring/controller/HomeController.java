...
@Controller // -> It Will Return .jsp file
//@RestController -> It Will Return JSON DATA
...
//This Return JSP File , So We Have To Use @Controler
	@RequestMapping("/save")
	public String save(Model model) {
		...
		model.addAttribute("data",saveStudent);		
		return "insertPage";
		// return studentService.saveStudent(student) -> it will give the saved data to
		// the browser // it Will Return The JSON data So We Have To Use @RestController
	}
